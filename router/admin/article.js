...
articleApp.get('/',article.getCount,(req,res,next)=>{
    ...
    req.page.p=req.query.p ? req.query.p : 1//判断url中是否有req.query.p，没有则位第一页
    req.page.p=req.page.p > req.page.total ? req.page.total : req.page.p//判断总数和url的大小
    req.page.p =req.page.p < 1 ? 1 : req.page.p//判断url中和1的大小，比一小则在第一页
